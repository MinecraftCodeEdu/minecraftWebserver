...
/** @export */ Blockly.Msg.CONTROLS_FOR_TITLE = "반복(for):%1값을%2~%3까지%4씩 증가시키며";
...
/** @export */ Blockly.Msg.CONTROLS_IF_MSG_ELSE = "아니면 (else) 실행";
/** @export */ Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "아니면서 만약 (else if)";
/** @export */ Blockly.Msg.CONTROLS_IF_MSG_IF = "만약 (if)";
...
/** @export */ Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = "실행";
/** @export */ Blockly.Msg.CONTROLS_REPEAT_TITLE = "반복(repeat):%1회";
...
/** @export */ Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "반복(while): 거짓 인 동안";
/** @export */ Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "반복(while): 참 인 동안";
...
/** @export */ Blockly.Msg.LISTS_LENGTH_TITLE = "%1리스트의 길이";
...
/** @export */ Blockly.Msg.LOGIC_BOOLEAN_FALSE = "거짓 (false)";
...
/** @export */ Blockly.Msg.LOGIC_BOOLEAN_TRUE = "참 (true)";
...
/** @export */ Blockly.Msg.LOGIC_NEGATE_TITLE = "반대로 (not)%1";
...
/** @export */ Blockly.Msg.LOGIC_TERNARY_CONDITION = "다음 조건이";
/** @export */ Blockly.Msg.LOGIC_TERNARY_HELPURL = "https://ko.wikipedia.org/wiki/물음표";
/** @export */ Blockly.Msg.LOGIC_TERNARY_IF_FALSE = "거짓일 때 값";
/** @export */ Blockly.Msg.LOGIC_TERNARY_IF_TRUE = "참일 때 값";
...
/** @export */ Blockly.Msg.MATH_CHANGE_TITLE = "%1값 %2증가";
...
/** @export */ Blockly.Msg.MATH_RANDOM_INT_TITLE = "%1~%2 랜덤 정수";
...
/** @export */ Blockly.Msg.PROCEDURES_DEFRETURN_RETURN = "반환 값";
...
/** @export */ Blockly.Msg.TEXT_JOIN_TITLE_CREATEWITH = "문자열 연결";
...
/** @export */ Blockly.Msg.TEXT_LENGTH_TITLE = "%1 문자열의 길이";
...
/** @export */ Blockly.Msg.VARIABLES_SET = "%1값 %2저장";
